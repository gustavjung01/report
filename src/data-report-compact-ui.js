function styleDataReportCompact(){
  ...
  style.textContent=`
    section.page[data-page="data"] .data-hub-tabs{grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:5px!important}
    section.page[data-page="data"] .data-hub-tab{min-width:0!important;min-height:48px!important;padding:6px 3px!important;border-radius:14px!important;gap:2px!important;line-height:1.05!important;box-shadow:0 5px 12px rgba(12,55,50,.045)!important}
    ...
    section.page[data-page="data"] .data-hub-tab[data-data-view="revenue"] span{font-size:9.8px!important;font-weight:850!important;letter-spacing:-.2px!important}
    section.page[data-page="data"] #dataShell.data-shell-report-compact .data-shell-kpis{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:6px!important;margin:2px 0 8px!important}
    ...
    section.page[data-page="data"] #dataShell.data-shell-report-compact .data-shell-list{display:grid!important;gap:7px!important;margin-top:0!important}
