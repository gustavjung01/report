function installDataMcpScrollUi(){
  ...
  style.textContent=`
    ...
    section.page[data-page="data"] #dataShell .data-shell-list{min-height:0!important;max-height:100%!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior:contain!important;padding:2px 4px 84px 2px!important;touch-action:pan-y!important}
    section.page[data-page="data"] #dataShell.data-shell-mcp-scroll .data-shell-list{display:block!important;gap:0!important;padding:2px 4px 88px 2px!important;scrollbar-gutter:stable!important}
