...
function pickerPanel() {
  return document.querySelector('#modal[data-type="order-create"] [data-order-picker-panel]');
}

function currentModal() {
  return document.querySelector('#modal[data-type="order-create"]');
}
