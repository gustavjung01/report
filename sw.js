const CACHE_NAME='bep-si-report-local-only-v45';
const ASSETS=['./','./index.html','./test-first-app.js','./src/ui-polish.js','./src/test-pull.js','./src/compact-detail.js','./src/app-update.js','./src/test-export.js','./src/modal-scroll-fix.js','./src/polish.css','./data-model.js','./local-db.js','./manifest.webmanifest','./icons/icon.svg','./icons/bepi-logo.svg','./favicon.ico'];
