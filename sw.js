const CACHE_NAME='bep-si-report-ui-polish-v40';
const ASSETS=['./','./index.html','./core-test-app.js','./test-first-app.js','./src/ui-polish.js','./src/polish.css','./data-model.js','./local-db.js','./supabase-v2.js','./manifest.webmanifest','./icons/icon.svg','./icons/bepi-logo.svg'];
